...
export async function recalculateSummary() {
  // 1. Hitung total Hutang Pabrik dari seluruh PO
  ...
  // 2. Hitung total Piutang Sales dari seluruh Tim
  ...
  // 3. Reset & Update doc summary
  // Total Aset di sini kita asumsikan = Nilai Stok + Piutang - Hutang (atau sesuai logika Anda)
  // Untuk sementara kita samakan dengan total input agar sinkron dengan delete
  await setDoc(SUMMARY_DOC, {
    totalAssets: totalPOValue, // Menyederhanakan agar tidak negatif
